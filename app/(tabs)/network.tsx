...
export default function NetworkScreen() {
  ...
  const handleNavigateToConnects = () => {
    // Navigate to your connections page when implemented
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headcont}>
          ...
          <View>
            <Button style={styles.connectbutton} onPress={handleNavigateToConnects}>
            ...
            <View style={[styles.section, { paddingBottom: 100 }]}>
              {Connects === null || Connects === undefined ? (
                <Text style={styles.guestText}>
                  You are a guest user. Sign In with registered email to access networking feature
                </Text>
              ) : (
                      ...
                      navigation={{
                        navigate: (screen: string, params: any) => {
                          if (screen === 'SingleConnect') {
                            ...
                            console.log('Navigate to single connect:', params.id);
                          }
                        }
                      }} 
                      btnText="Connect" 
